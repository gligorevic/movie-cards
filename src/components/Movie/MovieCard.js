  ...
  return (
    <div className="movie-card">
      <div className="movie-card card">
        <div className="movie-card__icon--delete" onClick={deleteMovie}>
        ...
        <div className="card-footer">
          <div className="clearfix">
            <div className="float-left mt-1">
              <StarRating rating={rating.avg} id={movie.id} />
            </div>
            <span onMouseEnter={() => setShowVotes(true)} onMouseLeave={() => setShowVotes(false)}>
              {!showVotes ? (
                <div className="card-footer-badge float-right badge badge-primary badge-pill">
                  {rating.avg.toPrecision(3)}
                </div>
              ) : (
                <div className="card-footer-badge float-right badge badge-primary badge-pill">
                  {rating.ratings.length} votes
                </div>
              )}
            </span>
          </div>
